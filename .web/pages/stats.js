...
export function Tbody_2085caa8e015f43f14ecce94b664e1da () {
  const state__state = useContext(StateContexts.state__state)


  return (
    <Tbody>
  {state__state.stats_to_show.map((row, index_743211e520cb92243cf71a29353ad65f) => (
...
export default function Component() {
  ...
  <Tbody_2085caa8e015f43f14ecce94b664e1da/>
</Table>
</VStack>
</Box>
  <Box sx={{"margin": "0.5em", "borderRadius": "lg", "borderColor": "#FAC934"}}>
