...
import { AlertDialog, AlertDialogBody, AlertDialogContent, AlertDialogFooter, AlertDialogHeader, AlertDialogOverlay, Box, Button, ButtonGroup, Center, Divider, Flex, Heading, HStack, Image, Input, Link, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay, Radio, RadioGroup, Spacer, Table, TableContainer, Tbody, Td, Text, Th, Thead, Tr, VStack } from "@chakra-ui/react"
...
export default function Component() {
  ...
  <Spacer/>
  <ButtonGroup>
  <Button onClick={(_e) => addEvents([Event("state.set_button_letter", {value:state.data["day_letters"].at(0)})], (_e), {})} sx={{"display": "block", "padding": "0.5em", "borderRadius": "0.8em", "bg": "#FAC934", "color": "#0B3C49"}}>
  {state.data["day_letters"].at(0)}
</Button>
  <Button onClick={(_e) => addEvents([Event("state.set_button_letter", {value:state.data["day_letters"].at(1)})], (_e), {})} sx={{"display": "block", "padding": "0.5em", "borderRadius": "0.8em", "bg": "#FAC934", "color": "#0B3C49"}}>
  {state.data["day_letters"].at(1)}
</Button>
  <Button onClick={(_e) => addEvents([Event("state.set_button_letter", {value:state.data["day_letters"].at(2)})], (_e), {})} sx={{"display": "block", "padding": "0.5em", "borderRadius": "0.8em", "bg": "#FAC934", "color": "#0B3C49"}}>
  {state.data["day_letters"].at(2)}
</Button>
  <Button onClick={(_e) => addEvents([Event("state.set_button_letter", {value:state.data["day_letters"].at(3)})], (_e), {})} sx={{"display": "block", "padding": "0.5em", "borderRadius": "0.8em", "bg": "#FAC934", "color": "#0B3C49"}}>
  {state.data["day_letters"].at(3)}
</Button>
  <Button onClick={(_e) => addEvents([Event("state.set_button_letter", {value:state.data["day_letters"].at(4)})], (_e), {})} sx={{"display": "block", "padding": "0.5em", "borderRadius": "0.8em", "bg": "#FAC934", "color": "#0B3C49"}}>
  {state.data["day_letters"].at(4)}
</Button>
  <Button onClick={(_e) => addEvents([Event("state.set_button_letter", {value:state.data["day_letters"].at(5)})], (_e), {})} sx={{"display": "block", "padding": "0.5em", "borderRadius": "0.8em", "bg": "#FAC934", "color": "#0B3C49"}}>
  {state.data["day_letters"].at(5)}
</Button>
  <Button onClick={(_e) => addEvents([Event("state.set_button_letter", {value:state.data["day_letters"].at(6)})], (_e), {})} sx={{"display": "block", "padding": "0.5em", "borderRadius": "0.8em", "bg": "#FAC934", "color": "#0B3C49"}}>
  {state.data["day_letters"].at(6)}
</Button>
</ButtonGroup>
</Box>
</Center>
  <Spacer/>
  <Box as={`form`} onSubmit={(_e0) => addEvents([Event("state.submit_word_handler", {form_data:{"word": getRefValue(ref_word)}})], (_e0), {"preventDefault": true})}>
  <VStack>
  <DebounceInput debounceTimeout={50} element={Input} id={`word`} inputRef={ref_word} onChange={(_e0) => addEvents([Event("state.set_text_to_show", {value:_e0.target.value})], (_e0), {})} placeholder={`Enter a word`} sx={{"borderColor": "#FAC934", "borderWidth": "medium", "color": "#0B3C49"}} type={`text`} value={state.compound_text}/>
  <HStack>
  ...
  <Box sx={{"margin": "0.5em", "borderRadius": "lg", "borderColor": "#FAC934"}}>
  <AlertDialog isOpen={state.alert_dialog_show}>
  <AlertDialogOverlay>
  <AlertDialogContent>
  <AlertDialogHeader>
  {`New tropy!`}
  ...
  <AlertDialogBody>
  {`Trophy ${state.trophy_number_to_show} - ${state.trophy_description_to_show}: ${state.data["word"]}.
Congratulations!`}
</AlertDialogBody>
  <AlertDialogFooter>
  <Button onClick={(_e) => addEvents([Event("state.trophy_alert_dialog_hide", {})], (_e), {})} sx={{"display": "block", "padding": "0.5em", "borderRadius": "0.8em", "bg": "#FAC934", "color": "#0B3C49"}}>
  {`Close`}
</Button>
</AlertDialogFooter>
</AlertDialogContent>
  ...
  <Tbody>
  {state.words_log_to_show.map((dhhzlexi, hjxpuafv) => (
  <Tr key={hjxpuafv}>
  {dhhzlexi.map((vpgmzvgt, cgpolwaq) => (
  <Td key={cgpolwaq}>
  {vpgmzvgt}
</Td>
))}
